...
function Movimento(nome, descricao, poder, alvo, precisao, prioridade){
    this.nome = nome,
    this.type = Type(),
    this.descricao = descricao,
    this.poder = poder,
...
function Pokemon(nome, numero, habilidade_oculta, estagio_evolucao, level, nivel_evolucao, exp, nickname){
    this.nome = nome,
    this.numero = numero,
    this.type = Type(),
...
const incendio = new Habilidade('incendio', 'aumento do poder de ataque para poemons de fogo', 'quando o HP do Pokémon que possui Blaze chegar a um terço, o poder dos seus ataques do tipo Fogo aumentarão 1.5 vezes')
