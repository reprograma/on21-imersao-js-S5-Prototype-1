...
function Damage(name, type, summary, power, target, accuracy, priority){
...
const damage1 = new Damage('Exemplo', 'type', 'summary', 'power', 'target', 'accuracy', 'priority')
console.log(damage1);
